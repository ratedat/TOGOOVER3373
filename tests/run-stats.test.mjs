...
test("normalizeRunStats fills all run stat fields", () => {
  const run = normalizeRunStats({ hope: "8", ingot: "20", lifePoints: undefined, shield: "bad", commandLevel: "4" });
  assert.deepEqual(run, { hope: 8, ingot: 20, lifePoints: null, shield: null, commandLevel: 4 });
});
