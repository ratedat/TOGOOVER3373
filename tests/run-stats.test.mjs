...
test("normalizeRunStats fills all run stat fields", () => {
  const run = normalizeRunStats({ hope: "8", lifePoints: undefined, shield: "bad", commandLevel: "4" });
  assert.deepEqual(run, { hope: 8, lifePoints: null, shield: null, commandLevel: 4 });
});
